...
# Get the latest version of EnaioMCP from github
RUN git clone https://github.com/Matze2010/EnaioMCPServer.git server
...
CMD ["fastmcp", "run", "server/EnaioMCP.py", "--host", "0.0.0.0", "--transport", "http", "--log-level", "INFO"]
